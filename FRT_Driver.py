...
class MLApp(QWidget):
    ...
    def validate_proportions(self):
        ...
        self.probabilities = {
                    "Male": float(self.demographic_widgets[6].text()) if self.demographic_widgets[6].text() else None,
                    "Female": float(self.demographic_widgets[7].text()) if self.demographic_widgets[7].text() else None,
                    "White": float(self.demographic_widgets[8].text()) if self.demographic_widgets[8].text() else None,
                    "Black": float(self.demographic_widgets[9].text()) if self.demographic_widgets[9].text() else None,
                    "Indian": float(self.demographic_widgets[10].text()) if self.demographic_widgets[10].text() else None,
                    "Asian": float(self.demographic_widgets[11].text()) if self.demographic_widgets[11].text() else None
                }
        return True
